...
// class AccNicTestRecvDriver(recvReqs: Seq[Int], recvData: Seq[BigInt])
...
// class AccNicRecvTest(implicit p: Parameters) extends NICLazyModule {
...
//   })
//   val recvDriver = LazyModule(new AccNicTestRecvDriver(recvReqs, recvData))
//   val recvPath = LazyModule(new AccNicRecvPath()(nicParams))
...
// class AccNicRecvTestWrapper(implicit p: Parameters) extends UnitTest(20000) {
//   val test = Module(LazyModule(new AccNicRecvTest).module)
//   test.io.start := io.start
//   io.finished := test.io.finished
// }

// class AccNicSendTest(implicit p: Parameters) extends LazyModule {
//   val sendReqs = Seq(
//     (2, 10, true),
//     (17, 6, false),
//     (24, 12, false))
...
// class AccNicSendTestWrapper(implicit p: Parameters) extends UnitTest {
//   val test = Module(LazyModule(new AccNicSendTest).module)
//   test.io.start := io.start
//   io.finished := test.io.finished
// }

// class AccNicTest(implicit p: Parameters) extends NICLazyModule {
//   val sendReqs = Seq(
//     (0, 128, true),
//     (144, 160, false),
//     (320, 64, false))
...
//   val sendDriver = LazyModule(new AccNicTestSendDriver(sendReqs, testData))
//   val recvDriver = LazyModule(new AccNicTestRecvDriver(recvReqs, testData))
//   val sendPath = LazyModule(new AccNicSendPath)
...
// class AccNicTestWrapper(implicit p: Parameters) extends UnitTest(50000) {
//   val test = Module(LazyModule(new AccNicTest).module)
//   test.io.start := io.start
//   io.finished := test.io.finished
// }
